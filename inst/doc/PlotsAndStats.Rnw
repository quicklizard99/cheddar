...
decide plotting colours and symbols. Producers are shown by open green circles, 
...
are producers are shown by open green circles, invertebrates by blue squares 
