...
must be present if the \code{properties.csv} file contains columns called 
...
A second package named foodweb \citealp{foodwebPerdomoEtAl} is available on 
CRAN. This package plots 3D graphs of webs.
<<eval=FALSE>>=
