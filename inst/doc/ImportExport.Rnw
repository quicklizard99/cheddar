...
extremely hard to write a generic 'import my data into Cheddar' function. 
Help is at hand! If you have community data that you would like to import into 
Cheddar, please contact me (lawrence.hudson08 (at) imperial.ac.uk) - I will 
